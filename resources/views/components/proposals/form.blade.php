<x-ui.modal>
    <form class="flex flex-col gap-6" wire:submit="save">
        <div>
            ...
            <div class="text-[16px] text-[#C3C3D1]">Faça sua oferta em horas mensais que você pode
                contribuir com o projeto.</div>
        </div>
        ...
        <div>
            <label for="agree"
                ...
                <span class="text-[#8C8C9A] text-[14px]">Concordo com os Termos e Políticas de
                    privacidade.</span>
            </label>
            @error('agree')
                <div class="text-red-600 mt-1 text-small"> {{ $message }}</div>
